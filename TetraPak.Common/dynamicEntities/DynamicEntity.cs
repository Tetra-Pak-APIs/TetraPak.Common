...
{
    [Serializable]
    [JsonConverter(typeof(DynamicEntityJsonConverter<tetrapak.dynamicEntities.DynamicEntity>))]
    public partial class DynamicEntity : IDictionary<string,object> 
    {
        ...
        public tetrapak.dynamicEntities.DynamicEntity ApplyFrom(object source) => onApplyFrom(source);

        tetrapak.dynamicEntities.DynamicEntity onApplyFrom(object source)
        {
        ...
        {
            var isDynamicEntity = source is tetrapak.dynamicEntities.DynamicEntity;
        ...
        public static TEntity FromJson<TEntity>(string json) where TEntity : tetrapak.dynamicEntities.DynamicEntity
        {
        ...
        {
            if (!typeof(tetrapak.dynamicEntities.DynamicEntity).IsAssignableFrom(returnType))
        ...
        public virtual TEntity Clone<TEntity>(ILog log = null) where TEntity : tetrapak.dynamicEntities.DynamicEntity
        {
        ...
        public object ObjectifyJsonElements() 
        {
            ...
            foreach (var pair in this)
            {
                ...
                else if (value.IsCollectionOf<tetrapak.dynamicEntities.DynamicEntity>(out var items))
                {
                    foreach (tetrapak.dynamicEntities.DynamicEntity entityItem in items)
                    {
