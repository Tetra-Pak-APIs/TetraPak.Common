...
namespace TetraPak
{
    public static class TypeHelper
    {
        ...
        public static bool Is(this Type self, Type type, bool laxEnumerationComparison = true, bool includeImplicitOperatorOverloads = false)
        {
            ...
            bool treatStringAsUnary = true)
        {
            ...
            if (type.IsGenericType)
            {
                var typeArgs = self.GetType().GenericTypeArguments;
        ...
        public static bool IsCollectionOf(this object self, Type itemType, out IEnumerable items, bool treatStringAsUnary = true)
        {
            items = null;
            switch (self)
            {
        ...
        public static bool IsCollectionOf<T>(this object self, out IEnumerable<T> items, bool treatStringAsUnary = true)
        {
            if (!self.IsCollectionOf(typeof(T), out var enumerable, treatStringAsUnary))
            {
                items = null;
                return false;
            }
        ...
        public static bool TryGetCollectionItemType(this Type collectionType, out Type iType)
        {
            while (true)
            {
        ...
        public static bool TryDeserializeStringValue(this Type targetType, string s, out object result)
        {
